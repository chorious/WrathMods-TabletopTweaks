...
namespace TabletopTweaks.Base.NewContent.Spells {
    internal class DeadlyJuggernaut {
        public static BlueprintAbilityReference AddDeadlyJuggernaut() {
            ...
            var statBonusBuff = Helpers.CreateBlueprint<BlueprintBuff>(TTTContext, "DeadlyJuggernautStatBonusBuff", bp => {
                bp.SetName(TTTContext, "Deadly Juggernaut");
            ...
            var buff = Helpers.CreateBlueprint<BlueprintBuff>(TTTContext, "DeadlyJuggernautBuff", bp => {
                bp.SetName(TTTContext, "Deadly Juggernaut");
                bp.SetDescription(TTTContext, "With every enemy life you take, you become increasingly dangerous and difficult to stop." +
                    " During the duration of the spell, you gain a cumulative +1 profane bonus on melee attack rolls, melee weapon damage " +
                    "rolls, Strength checks, and Strength-based skill checks as well as DR 2/— each time you reduce a qualifying opponent" +
            ...
            return Helpers.CreateBlueprint<BlueprintAbility>(TTTContext, "DeadlyJuggernaut", bp => {
                bp.SetName(TTTContext, "Deadly Juggernaut");
                bp.SetDescription(TTTContext, "With every enemy life you take, you become increasingly dangerous and difficult to stop." +
                    " During the duration of the spell, you gain a cumulative +1 profane bonus on melee attack rolls, melee weapon damage " +
                    "rolls, Strength checks, and Strength-based skill checks as well as DR 2/— each time you reduce a qualifying opponent" +
                ...
                bp.AddToSpellList(SpellTools.SpellList.ClericSpellList, 3);
                bp.AddToSpellList(SpellTools.SpellList.PaladinSpellList,3);
                bp.AddToSpellList(SpellTools.SpellList.InquisitorSpellList,3);
        ...
        private static void AddKiDeadlyJuggernaut(UnityEngine.Sprite icon, BlueprintBuff buff) {
            ...
            var ability = Helpers.CreateBlueprint<BlueprintAbility>(TTTContext, "KiDeadlyJuggernautAbility", bp => {
                bp.SetName(TTTContext, "Ki Power: Deadly Juggernaut");
            ...
            var feature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "KiDeadlyJuggernautFeature", bp => {
                bp.SetName(TTTContext, "Ki Power: Deadly Juggernaut");
                bp.SetDescription(TTTContext, "A monk with this ki power can spend 2 points from his ki pool as a standard action to grant himself Deadly Juggernaut buff: \nWith every enemy life you take, you become increasingly dangerous and difficult to stop." +
                    " During the duration of the spell, you gain a cumulative +1 profane bonus on melee attack rolls, melee weapon damage " +
                    "rolls, Strength checks, and Strength-based skill checks as well as DR 2/— each time you reduce a qualifying opponent" +
            ...
            var sfAbility = Helpers.CreateBlueprint<BlueprintAbility>(TTTContext, "ScaledFistKiDeadlyJuggernautAbility", bp => {
                bp.SetName(TTTContext, "Ki Power: Deadly Juggernaut");
                bp.SetDescription(TTTContext, "A monk with this ki power can spend 2 points from his ki pool as a standard action to grant himself Deadly Juggernaut buff: \nWith every enemy life you take, you become increasingly dangerous and difficult to stop." +
                    " During the duration of the spell, you gain a cumulative +1 profane bonus on melee attack rolls, melee weapon damage " +
                    "rolls, Strength checks, and Strength-based skill checks as well as DR 2/— each time you reduce a qualifying opponent" +
            ...
            var sfFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ScaledFistKiDeadlyJuggernautFeature", bp => {
                bp.SetName(TTTContext, "Ki Power: Deadly Juggernaut");
                bp.SetDescription(TTTContext, "A monk with this ki power can spend 2 points from his ki pool as a standard action to grant himself Deadly Juggernaut buff: \nWith every enemy life you take, you become increasingly dangerous and difficult to stop." +
                    " During the duration of the spell, you gain a cumulative +1 profane bonus on melee attack rolls, melee weapon damage " +
                    "rolls, Strength checks, and Strength-based skill checks as well as DR 2/— each time you reduce a qualifying opponent" +
